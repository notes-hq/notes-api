...
Интерактивная документация API после запуска backend доступна по адресу:

```text
http://localhost:3000/api-docs
```

Swagger UI отображает существующую спецификацию `openapi.yaml` и не является
отдельным источником документации.
